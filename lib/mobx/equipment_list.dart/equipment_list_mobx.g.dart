...
mixin _$EquipmentListMobx on EquipmentListMobxBase, Store {
  Computed<dynamic> _$getEquipmentListComputed;

  @override
  dynamic get getEquipmentList => (_$getEquipmentListComputed ??=
          Computed<dynamic>(() => super.getEquipmentList,
              name: 'EquipmentListMobxBase.getEquipmentList'))
      .value;
